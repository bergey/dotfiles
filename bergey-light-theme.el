(deftheme bergey-light)

(custom-theme-set-faces
 'bergey-light
 '(minibuffer-prompt ((((class color) (min-colors 89)) (:foreground "forest green"))))
 ...
 '(font-lock-variable-name-face ((((class color) (min-colors 89)) (:foreground "orchid"))))
 '(link ((((class color) (min-colors 89)) (:underline t :foreground "cornflower blue"))))
 ...
 '(rainbow-delimiters-depth-2-face ((((class color) (background dark)) (:foreground "chocolate"))))
 '(rainbow-delimiters-depth-3-face ((((class color) (background dark)) (:foreground "blue"))))
 '(rainbow-delimiters-depth-4-face ((((class color) (background dark)) (:foreground "magenta"))))
 '(rainbow-delimiters-depth-5-face ((((class color) (background dark)) (:foreground "black"))))
 '(rainbow-delimiters-depth-6-face ((((class color) (background dark)) (:foreground "purple"))))
 '(rainbow-delimiters-depth-7-face ((((class color) (background dark)) (:foreground "orange"))))
 '(rainbow-delimiters-depth-8-face ((((class color) (background dark)) (:foreground "forest green"))))
 '(rainbow-delimiters-depth-9-face ((((class color) (background dark)) (:foreground "gray"))))
 '(ledger-font-xact-highlight-face ((((class color) (background dark)) (:background "white"))))
 '(erc-notice-face ((((class color) (background dark)) (:foreground "LightSteelBlue4"))))
 '(italic ((t (:underline nil :slant italic))))
 '(monospace ((t (:family "Inconsolata"))))
 '(default
    ((t (:inherit nil :stipple nil :background "white" :foreground "dark slate gray"
                  :inverse-video nil :box nil :strike-through
                  nil :overline nil
                  :underline nil :slant normal :weight normal
                  :height 100 :width normal)))))

(provide-theme 'bergey-light)
